...
// 环境变量
const UUID = process.env.UUID || 'f715554d-5ac4-4677-bb5d-ce2baff8d621'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const DOMAIN = process.env.DOMAIN || 'hugface.qiudao.dpdns.org';                   // 域名或ip,留空将自动获取服务器ip
